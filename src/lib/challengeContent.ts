...
const MONTH_3_DAYS_CONTENT: Omit<ChallengeDayContent, 'illustration'>[] = [
  ...
  { day: 11, type: 'game', area: 'calculo', title: 'Camino numérico',
    instructions: 'Un juego de cálculo: tocá los números dispersos por la pantalla en orden, del más chico al más grande. Subís de dificultad a medida que avanzás.' },
  ...
  { day: 17, type: 'game', area: 'atencion', title: 'Fluencia con reglas',
    instructions: 'Un juego de atención: mirá la lista de combinaciones de palabras y tocá las que siguen la regla de letras de hoy. Subís de dificultad a medida que avanzás.' },
  ...
  { day: 21, type: 'game', area: 'atencion', title: 'El hilo invisible',
    instructions: 'Un juego de atención: el ícono marcado tiene una línea que se cruza con las demás. Seguila con la vista y tocá, fila por fila, el número donde sigue tu línea. Subís de dificultad a medida que avanzás.' },
  { day: 22, type: 'game', area: 'agnosias', title: 'Armá el rompecabezas',
    instructions: 'Un juego de armado: la foto se corta en 4 pedacitos y hay señuelos de otras fotos mezclados. Tocá un pedacito y después el lugar del rompecabezas donde creas que va. Subís de dificultad a medida que avanzás.' },
  ...
  { day: 24, type: 'game', area: 'memoria', title: 'La intrusa de la lista',
    instructions: 'Un juego de memoria: memorizá una lista corta y después encontrá, entre las mismas palabras reordenadas, cuál es la intrusa que se agregó. Subís de dificultad a medida que avanzás.' },
...
const MONTH_4_DAYS_CONTENT: Omit<ChallengeDayContent, 'illustration'>[] = [
  ...
  { day: 8, type: 'game', area: 'calculo', title: 'Crucigrama de cifras',
    instructions: 'Un juego de cálculo: tocá un número del banco y después el casillero donde creas que va, hasta que todas las cuentas del crucigrama cierren. Subís de dificultad a medida que avanzás.' },
  { day: 9, type: 'game', area: 'memoria', title: '¿Qué hay en la mesa?',
    instructions: 'Un juego de memoria: mirá con atención los objetos de la mesa y después reconocé cuáles estaban, entre otros que no. Subís de dificultad a medida que avanzás.' },
  { day: 10, type: 'game', area: 'lenguaje', title: 'Animal por letra',
    instructions: 'Un juego de lenguaje: te damos una letra y tenés que tocar cuál de los animales empieza con ella. Subís de dificultad a medida que avanzás.' },
  ...
  { day: 14, type: 'game', area: 'atencion', title: 'El color de la palabra',
    instructions: 'Un juego de atención: en el tablero hay nombres de colores pintados de distintos colores. Tocá sólo los que están escritos con su propio color. Subís de dificultad a medida que avanzás.' },
  { day: 15, type: 'game', area: 'memoria', title: '¿Quién lo dijo?',
    instructions: 'Un juego de memoria: primero conocés a unas personas y algo de su vida. Después aparece una frase y tenés que acordarte cuál de ellas la diría. Subís de dificultad a medida que avanzás.' },
  { day: 16, type: 'game', area: 'ejecutivas', title: '¿Verdadero o falso?',
    instructions: 'Un juego de razonamiento: leé la afirmación y decidí si es verdadera o falsa. Después te contamos por qué. Subís de dificultad a medida que avanzás.' },
  { day: 17, type: 'game', area: 'calculo', title: '¿Alcanza la plata?',
    instructions: 'Un juego de cálculo: mirá lo que hay que comprar y la plata disponible, y decidí si alcanza o no. Subís de dificultad a medida que avanzás.' },
  { day: 18, type: 'game', area: 'praxias', title: '¿Qué sigue?',
    instructions: 'Un juego visoespacial: la fila de figuras sigue una regla escondida. Descubrila y tocá cuál va después. Subís de dificultad a medida que avanzás.' },
  { day: 19, type: 'game', area: 'lenguaje', title: '¿Qué objeto es?',
    instructions: 'Un juego de lenguaje: leé la adivinanza y tocá cuál de los objetos es el que describe. Subís de dificultad a medida que avanzás.' },
  ...
  { day: 21, type: 'game', area: 'agnosias', title: 'Sólo un pedacito',
    instructions: 'Un juego de reconocimiento visual: se ve apenas un pedacito de un animal. Mirá el color y la textura y tocá cuál es. Subís de dificultad a medida que avanzás.' },
  { day: 22, type: 'game', area: 'ejecutivas', title: '¿Qué oficio es?',
    instructions: 'Un juego de razonamiento: mirá las herramientas y tocá a qué oficio pertenecen. Subís de dificultad a medida que avanzás.' },
  { day: 23, type: 'game', area: 'atencion', title: 'Las diferencias',
    instructions: 'Un juego de atención: hay dos dibujos casi iguales. Comparálos con calma y tocá lo que cambia de uno al otro. Subís de dificultad a medida que avanzás.' },
  { day: 24, type: 'game', area: 'lenguaje', title: '¿Cómo se llamaba?',
    instructions: 'Un juego de lenguaje: mirá el objeto y tocá cómo se llama entre las opciones. Subís de dificultad a medida que avanzás.' },
  ...
  { day: 26, type: 'game', area: 'agnosias', title: 'Caras y emociones',
    instructions: 'Un juego de reconocimiento: mirá la cara y tocá qué emoción está sintiendo, o al revés, buscá la cara que va con la emoción. Subís de dificultad a medida que avanzás.' },
  ...
  { day: 28, type: 'game', area: 'memoria', title: 'Leer y responder',
    instructions: 'Un juego de memoria y comprensión: leé una historia corta con calma, sin apuro, y después respondé unas preguntas sobre lo que leíste. Subís de dificultad a medida que avanzás.' },
  { day: 29, type: 'game', area: 'orientacion', title: 'Ordená tu semana',
    instructions: 'Un ejercicio de orientación con tu propia historia: tocá los días que fuiste completando este mes y ponelos en el orden en que los hiciste.' },
  { day: 30, type: 'game', area: 'calculo', title: 'Tu resumen',
    instructions: '¡Último día! Un cierre hecho con tus propios números: cuántos ejercicios hiciste, cómo te fue, hasta dónde llegaste. 🎉' },
]
