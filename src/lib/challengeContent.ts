...
const MONTH_4_DAYS_CONTENT: Omit<ChallengeDayContent, 'illustration'>[] = [
  { day: 1, type: 'game', area: 'lenguaje', title: 'Flor de palabra',
    instructions: 'Un juego de lenguaje: con las letras de la flor se arman varias palabras. Leé la pista, tocá las letras en orden y formá la palabra. Subís de dificultad a medida que avanzás.' },
  ...
  { day: 7, type: 'game', area: 'lenguaje', title: 'Detectives del parque',
    instructions: 'Un juego de lenguaje: mirá bien la escena del parque. Aparece una letra y tenés que tocar, dentro del dibujo, algo que empiece con esa letra. Subís de dificultad a medida que avanzás.' },
  ...
  { day: 16, type: 'game', area: 'ejecutivas', title: '¿Quién es cada uno?',
  ...
  { day: 22, type: 'game', area: 'ejecutivas', title: 'El árbol de la familia',
    instructions: 'Un juego de razonamiento: leé cómo se relacionan los integrantes de una familia y ubicá cada nombre en su casillero del árbol. Tocá un nombre y después el casillero. Subís de dificultad a medida que avanzás.' },
  ...
  { day: 24, type: 'game', area: 'ejecutivas', title: 'A viajar',
    instructions: 'Un juego de razonamiento: leé las pistas y deducí en qué viaja cada persona y a dónde va. Tocá una palabra de la lista y después la casilla donde creas que va. Subís de dificultad a medida que avanzás.' },
