...
const DAYS_CONTENT: Omit<ChallengeDayContent, 'illustration'>[] = [
  ...
  { day: 27, type: 'game', area: 'agnosias', title: '¿Cuántos hay?',
    instructions: 'Un juego de reconocimiento: muchos dibujos se superponen y se repiten en una sola imagen. Contá cuántos hay de cada uno. Subís de dificultad a medida que avanzás.' },
