...
const LEVELS: Level[] = [
  ...
  },
  {
    ...
    rounds: [
      ...
      { sequence: ['frutilla', 'frutilla', 'naranja', 'frutilla', 'frutilla'], answer: 'naranja', decoys: ['frutilla', 'mandarina', 'pina'] },
      { sequence: ['cereza', 'cereza', 'zanahoria', 'cereza', 'cereza'], answer: 'zanahoria', decoys: ['cereza', 'arandanos', 'ciruela'] },
    ],
  },
  {
    n: 3,
    name: 'Nivel 3',
    pool: 'object',
    hint: 'Ahora el patrón se repite cada 4 imágenes en lugar de 2 o 3. Repasá toda la fila antes de responder.',
    rounds: [
      ...
      { sequence: ['diario', 'diario', 'pelota', 'pelota', 'diario'], answer: 'diario', decoys: ['pelota', 'portarretrato', 'control-remoto'] },
      { sequence: ['boton', 'boton', 'lapicera', 'lapicera', 'boton'], answer: 'boton', decoys: ['lapicera', 'dedal', 'azucarera'] },
    ],
  },
]
