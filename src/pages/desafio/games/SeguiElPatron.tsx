...
export function SeguiElPatron({ day: _day, onComplete }: GameProps) {
  ...
  // Qué rounds están en juego para cada nivel en ESTA "epoch" (una pasada
  // completa de 3 niveles). Se deciden una sola vez, al montar — nunca se
  // re-generan sólo porque el jugador vuelve a visitar un nivel, así
  // "Repetir" devuelve exactamente los mismos rounds.
  ...
  // Usada por restartSame en la tarjeta del último nivel. roundKey siempre
  // se incrementa acá: es el contador de "qué intento es este" que el
  // efecto de onComplete usa para volver a disparar en una repetición.
