...
export function SeguiElPatron({ day: _day, onComplete }: GameProps) {
  ...
  // completa de 3 niveles). Se deciden una sola vez por epoch — al montar, y
  // de nuevo sólo en "Hacer otro" — nunca se re-generan sólo porque el
  // jugador vuelve a visitar un nivel, así "Repetir" devuelve exactamente
  // los mismos rounds en vez de generar otros nuevos por accidente.
