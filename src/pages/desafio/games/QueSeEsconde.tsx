...
const LEVELS: Level[] = [
  ...
  },
  {
    ...
    name: 'Nivel 3',
    compositions: [
      { items: [{ objectId: 'tortuga', xPct: 50, yPct: 52, scale: 0.85 }, { objectId: 'manzana-roja', xPct: 38, yPct: 42, scale: 0.72 }, { objectId: 'banana', xPct: 60, yPct: 40, scale: 0.78, rotationDeg: 25 }, { objectId: 'tijera', xPct: 52, yPct: 62, scale: 0.72, rotationDeg: -30 }], decoyIds: ['reloj-pulsera', 'zanahoria', 'rana', 'oso'] },
      { items: [{ objectId: 'mate', xPct: 42, yPct: 46, scale: 0.82, rotationDeg: -8 }, { objectId: 'pato', xPct: 60, yPct: 42, scale: 0.72, rotationDeg: 10 }, { objectId: 'corazon', xPct: 40, yPct: 66, scale: 0.66 }, { objectId: 'zanahoria', xPct: 62, yPct: 64, scale: 0.76, rotationDeg: 18 }], decoyIds: ['reloj-pulsera', 'tortuga', 'sol', 'banana'] },
      { items: [{ objectId: 'tortuga', xPct: 50, yPct: 54, scale: 0.82 }, { objectId: 'guitarra', xPct: 40, yPct: 40, scale: 0.82, rotationDeg: -15 }, { objectId: 'anteojos', xPct: 60, yPct: 38, scale: 0.78, rotationDeg: 8 }, { objectId: 'reloj-pulsera', xPct: 58, yPct: 64, scale: 0.68, rotationDeg: -10 }], decoyIds: ['llaves', 'paraguas', 'rana', 'manzana-roja'] },
      { items: [{ objectId: 'oso', xPct: 50, yPct: 50, scale: 0.82 }, { objectId: 'banana', xPct: 38, yPct: 38, scale: 0.76, rotationDeg: 25 }, { objectId: 'rana', xPct: 62, yPct: 40, scale: 0.72 }, { objectId: 'camion-bomberos', xPct: 52, yPct: 66, scale: 0.82, rotationDeg: -8 }], decoyIds: ['zanahoria', 'pato', 'mariposa', 'reloj-pulsera'] },
    ],
  },
]
