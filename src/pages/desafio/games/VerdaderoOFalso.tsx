...
const LEVELS: Level[] = [
  ...
  },
  {
    ...
    statements: [
      ...
      { id: 'l3-siglo', text: 'Un siglo tiene 100 años.', answer: true, explanation: 'Correcto: un siglo son exactamente 100 años.' },
      ...
      { id: 'l3-mitad-100', text: 'La mitad de 100 es 40.', answer: false, explanation: 'La mitad de 100 es 50, no 40.' },
    ],
  },
]
