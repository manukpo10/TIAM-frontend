...
export function CruceDeLetras({ day: _day, onComplete }: GameProps) {
  ...
  // (al montar y de nuevo en "Hacer otro"), nunca al re-visitar un nivel, así
  // "Repetir" siempre devuelve la misma grilla.
  ...
  function restartDifferent() {
    restartEpoch()
    setEpochEntries(LEVELS.map((lvl, i) => shuffle(lvl.grids).slice(0, ROUNDS_PER_LEVEL[i])))
  }
